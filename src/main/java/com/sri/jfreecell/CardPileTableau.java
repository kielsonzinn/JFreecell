...
/**
 * Card pile with the initial cards. Only need to specify rules for adding
 * cards. Default rules apply to remove them.
 *
...
public class CardPileTableau extends CardPile {
    ...
    * @param topCard
    * @param btmCard
    * @return true, if face value is one lower and it's the opposite color else
    *         false
    */
